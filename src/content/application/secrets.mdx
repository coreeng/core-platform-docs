...
Sensitive configuration, i.e. secrets, can be configured in GitHub, and passed to the applications as Environment Variables via the [P2P pipeline](/p2p/overview).
