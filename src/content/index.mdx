...
Welcome to the [Core Platform](https://coreplatform.io/) Documentation!
...
please go to [Core Platform](https://coreplatform.io/) to get in touch with us to set up
your environments.
...
- Want to deploy a new application? See [Deploying Applications](./application)
