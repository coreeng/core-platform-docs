...
- _Right away:_ Fast feedback runs right away, followed by extended test, followed by production deployment.
- _On a schedule:_ Fast feedback runs right away, extended test and production run on a schedule.
- _Manually:_ Fast feedback runs right away, extended test and production are manually triggered.
