...
- Inherit prod groups for app tenant creation by @kkonstan
- Update dependencies by @kkonstan
...
- Update core-platform by @coquinncecg

## v0.54.1

- Fix monorepo app tenant onboarding by @kkonstan
- Stop setting TENANT_NAME as repo variable by @kkonstan
...
- Update core-platform by @kkonstan

## v0.52.1

- Add --public flag to corectl app create for public repository creation by @kkonstan
...
- Update go dependencies by @pyoio

## v0.41.8

- Add support to app.yaml to render by @kkonstan

## v0.41.7

- Improve app.yaml by @kkonstan

## v0.41.6

- Add support for app.yaml by @kkonstan
...
- Fix handling of undefined values by @kkonstan

## v0.41.3

- Add --config to the cmd command by @kkonstan

## v0.41.2

- Create app tenants automatically by @kkonstan

## v0.41.1

- Prevent adding repos to team tenants by @kkonstan

## v0.41.0

- Add kind as part of tenant filename by @kkonstan
