...
- Add core platform dashboard agent by @kkonstan

## v0.60.1

- Improve platform-ingress tests by @jescard-tamer-cecg
- Implement GKE balanced node pool autoscaling placement by @kkonstan

## v0.60.0

- Use platform readonly group for ingress IAP by @kkonstan
- Add mandatory platform access groups by @kkonstan

## v0.59.4

- Fix infra-operator cleanup by @kkonstan

## v0.59.3

- Fix platform ingress CRD planning by @kkonstan

## v0.59.2

- Add ingress support for websockets by @kkonstan
...
- Add prod tier specific tenant groups by @kkonstan

## v0.58.0

- Add environment tier classification by @kkonstan

## v0.57.2

- Adjust disruption budgets for core workloads by @kkonstan
- Improve terragrunt caching by @kkonstan
...
- Update platform-portal by @pyoio

## v0.56.3

- Update platform-portal by @kkonstan
- Update platform-portal to be redis only by @kkonstan
- Update platform-portal to enable dependabot alerts by @kkonstan

## v0.56.2

- Make node boot disk size configurable by @kkonstan
...
- Deprecate TENANT repo variable by @kkonstan

## v0.55.1

- Update platform-portal by @coquinncecg

## v0.55.0

- Updated tenant schema ADR by @coquinncecg
- Internal documentation updates by @coquinncecg
- Improve platform-ingress dependencies order by @coquinncecg
- Update tenant schema implementation by @coquinncecg
- Increase platform-ingress load balancer helm timeout by @kkonstan

## v0.54.1

- Update contributing guide by @coquinncecg
- Update platform-portal by @kkonstan

## v0.54.0

- Improve OpenTelemetry operator by @kkonstan
- Enable GKE Dataplane V2 flow observability tools by @kkonstan

## v0.53.3

- Improve continuous load test by @kkonstan
- Update platform-portal by @kkonstan
- Improve continuous load exporter by @kkonstan

## v0.53.2

- Update platform-portal by @kkonstan
- Fix platform-ingress bootstrap race condition by @kkonstan

## v0.53.1

- Deprecate gcp-init by @kkonstan
- Update platform-portal by @kkonstan

## v0.53.0

- Make readonly IAM group configurable by @kkonstan
- Update environment schema validation by @kkonstan

## v0.52.9

- Fix cert-manager SA by @kkonstan

## v0.52.8

- Fix bastion zone selection by @kkonstan

## v0.52.7

- Fix gcp zone detection by @kkonstan

## v0.52.6

- Improve bastion zone selection by @kkonstan

## v0.52.5

- Support pre-created cert-manager SAs by @kkonstan
...
- Fix cert-manager by @kkonstan

## v0.52.2

- Support ingress base domain fix by @kkonstan

## v0.52.1

- Update environments schema by @kkonstan
- Update environments validator by @kkonstan
- Support ingress base domain by @kkonstan

## v0.52.0

- Support (optional) shared DNS zone by @kkonstan
...
- Improve multi-region support by @kkonstan
