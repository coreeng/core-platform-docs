...
Start by configuring the [Core Platform CLI](./docs/corectl) and then follow the guides below.
...
- Want to deploy a new application? See [Deploying Applications](./docs/app)
- Want a full reference for how to use implement Continuous Delivery? See [Path to Production](./docs/p2p)
- Are you operationally responsible for the platform? See [Platform Operations](./docs/platform)
